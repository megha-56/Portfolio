...
const Skills=()=>{
  ...
  />
            ...
            <div className='grid font-mono font-mono grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-[70%]'>
...
//                 <button onClick={() => router.push("/allskills")} className={`px-5 py-2 cursor-pointer rounded-full text-sm font-medium transition-all duration-300 border border-black/10 ${pathname === "/allskills" ? "bg-white text-black" : "bg-white/50 text-black"}`}>All</button>
