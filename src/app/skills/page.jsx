...
const Skills=()=>{
    ...
    return(
        <div className=" flex flex-col items-center min-h-screen w-full bg-white gap-5" >
            ...
            <div>
                <h1 className="text-5xl mt-10 font-bold  text-black">Skills & Technologies</h1>
            </div>
            <div>
            ...
            <div className='flex flex-wrap justify-center gap-2 mb-12'>
                     <button className='px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 bg-white border border-black/10 text-gray-400 hover:text-black hover:border-black/20'>All</button>
                     <button className='px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 bg-white border border-black/10 text-gray-400 hover:text-black hover:border-black/20'>Frontend</button>
                     <button className='px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 bg-white border border-black/10 text-gray-400 hover:text-black hover:border-black/20'>Backend</button>
                     <button className='px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 bg-white border border-black/10 text-gray-400 hover:text-black hover:border-black/20'>Language</button>
                     <button className='px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 bg-white border border-black/10 text-gray-400 hover:text-black hover:border-black/20'>Database</button>
                     <button className='px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 bg-white border border-black/10 text-gray-400 hover:text-black hover:border-black/20'>Tools</button>
                     <button className='px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 bg-white border border-black/10 text-gray-400 hover:text-black hover:border-black/20'>DevOps</button>
            </div>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-[70%]'>
                <div className='gradient-border p-5 rounded-2xl group hover:bg-gray-50 transition-all duration-500 animate-fade-in-up' >
                  ...
                  <div className='gradient-border p-5 rounded-2xl group hover:bg-gray-50 transition-all duration-500 animate-fade-in-up' >
                    ...
                    <span className="text-xs text-gray-400 mt-2 block">Language</span>
                  </div>  
                  ...
                  <div className='gradient-border p-5 rounded-2xl group hover:bg-gray-50 transition-all duration-500 animate-fade-in-up' >
                    ...
                    <span className="text-xs text-gray-400 mt-2 block">Backend</span>
                  </div>  
                ...
                <div className='gradient-border p-5 rounded-2xl group hover:bg-gray-50 transition-all duration-500 animate-fade-in-up' >
                  ...
                  <div className='gradient-border p-5 rounded-2xl group hover:bg-gray-50 transition-all duration-500 animate-fade-in-up' >
                    ...
                    <span className="text-xs text-gray-400 mt-2 block">Tools</span>
                  </div>  
                  ...
                  <div className='gradient-border p-5 rounded-2xl group hover:bg-gray-50 transition-all duration-500 animate-fade-in-up' >
                    ...
                    <span className="text-xs text-gray-400 mt-2 block">DevOps</span>
                  </div>  
