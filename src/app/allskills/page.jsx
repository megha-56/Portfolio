...
const Skills=()=>{
    ...
    return(
        <>
        <div className=" flex flex-col mb-20 items-center min-h-screen w-full  gap-5" >
  ...
  />
            ...
            <div className='flex flex-wrap justify-center gap-2 mb-12'>
                     <button onClick={()=>{router.push("/allskills")}} className={`px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300  border border-black/10  cursor-pointer   ${pathname === "/allskills" ? "bg-white text-black" : "bg-white/50 text-black"} `}>All</button>
                     <button onClick={()=>{router.push("/frontendSkills")}}  className={`px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300  border border-black/10  hover:text-black hover:border-black/20 active:bg-black cursor-pointer ${pathname === "/frontendSkills" ? "bg-white text-black" : "bg-white/50 text-black"} `}>Frontend</button>
                     <button onClick={()=>{router.push("/backendSkills")}} className={`px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 border border-black/10  hover:text-black hover:border-black/20 active:bg-black cursor-pointer ${pathname === "/backendSkills" ? "bg-white text-black" : "bg-white/50 text-black"}`}>Backend</button>
                     <button onClick={()=>{router.push("/language")}} className={`px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 border border-black/10  hover:text-black hover:border-black/20 active:bg-black cursor-pointer ${pathname === "/language" ? "bg-white text-black" : "bg-white/50 text-black"}`}>Language</button>
                     <button onClick={()=>{router.push("/database")}} className={`px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 border border-black/10  hover:text-black hover:border-black/20 active:bg-black cursor-pointer ${pathname === "/database" ? "bg-white text-black" : "bg-white/50 text-black"}`} >Database</button>
                     <button onClick={()=>{router.push("/tools")}} className={`px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 border border-black/10  hover:text-black hover:border-black/20 active:bg-black cursor-pointer ${pathname === "/tools" ? "bg-white text-black" : "bg-white/50 text-black"}`}>Tools</button>
                     <button onClick={()=>{router.push("/devops")}} className={`px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 border border-black/10  hover:text-black hover:border-black/20 active:bg-black cursor-pointer ${pathname === "/devops" ? "bg-white text-black" : "bg-white/50 text-black"}`}>DevOps</button>
            </div>
