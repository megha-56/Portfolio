...
//                <div className='rounded-full mx-auto h-[1] bg-white   w-[15%] overflow-hidden '>
...
//                 <div className='h-130 bg-white shadow shadow-white w-[27%] border border-top border-gray-300 rounded-2xl shadow object hover:shadow-2xl'>
    ...
    return(
       ...
       <div className="relative flex flex-col items-center min-h-screen w-full gap-5">
           ...
           <div className="absolute inset-0 -z-10">
            ...
            {/* NAVBAR */}
            <div className="h-12 flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-10 text-xs font-bold w-screen bg-[#525251] px-2">
              ...
              <button onClick={() => window.open("/resume.pdf", "_blank")} className='flex border bg-black rounded-2xl h-[50%] px-4 py-1 mt-2 sm:mt-3'>RESUME</button>
            </div>

            {/* HEADER */}
            <div className='flex flex-col font-mono items-center gap-5 px-4 text-center'>
               <h1 className='text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mt-16'>
                 Featured Projects
               </h1>
               <h2 className='text-sm sm:text-base md:text-lg text-white'>
                 Some of the things I've built recently
               </h2>

               <div className='rounded-full mx-auto h-[1] bg-white w-[40%] sm:w-[25%] md:w-[15%] overflow-hidden'>
                   <div className='rounded-full bg-white h-full w-full'></div>
               </div>
            </div>

            {/* PROJECTS */}
            <div className='flex flex-wrap gap-6 sm:gap-8 md:gap-10 min-h-200 w-full justify-center mt-10 px-4'>

                <div className='h-130 bg-white shadow shadow-white w-full sm:w-[45%] md:w-[30%] lg:w-[27%] border border-gray-300 rounded-2xl hover:shadow-2xl'>
                    
                    <div className='flex flex-col items-center gap-3 justify-center h-50 bg-gray-100 rounded-2xl'>
                        <div className='flex justify-center items-center h-15 w-15 bg-black rounded-2xl text-2xl font-bold'>F</div>
                        <div><h2 className='text-black/25'>Ice-cream Website</h2></div>
                    </div>

                    <div className='flex flex-col h-100 w-full px-5 sm:px-7 py-5 gap-5'>
                        <h1 className='text-xl font-bold text-black/90'>Frozen-Scoops</h1>

                        <p className='text-black/40 text-sm'>
                          Frozen Scopps is an Icecream Website, having a range of iceCreams, milkshakes, Yoghurts etc.
                        </p>
                        ...
                        <div className='flex flex-wrap gap-3 sm:gap-5'> 
                            <button
                              className='flex h-10 bg-gray-200 px-4 py-2 rounded gap-3 text-black text-sm items-center'
                            ...
                            <button
                              className='flex h-10 bg-black px-4 py-2 rounded gap-3 text-sm items-center'
