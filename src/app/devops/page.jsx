    ...
    return(
        <div className=" flex flex-col items-center min-h-screen w-full bg-white gap-5" >
            ...
            <div className='flex flex-wrap justify-center gap-2 mb-12'>
                     ...
                     <button onClick={()=>{router.push("/devops")}} className={`px-5 py-2 rounded-full text-sm font-medium transition-all duratiion-300 border border-black/10   hover:border-black/20 active:bg-black ${pathname === "/devops" ? "bg-black text-white" : "bg-white text-gray-400"}`}>DevOps</button>
            </div>
